//------------------------------------------------------------------------------
// Author: Arthur Schwaiger <arthur.schwaiger@gmail.com>
//
// AR.Drone.Kinect Project --
// AR Drone project based on Microsoft examples from Kinect for Windows Developer Toolkit v1.7.0
// Goal is to easily control AR Drone by gestures and voice.
// 
// Copyright for Kinect examples: 
...
namespace Microsoft.Samples.Kinect.SkeletonBasics
{
    ...
    public partial class MainWindow : Window
    {
        ...
        /// <summary>
        /// Whether or not AR Drone voice command is enable (say "Drone" to enable it)
        /// </summary>
        private Boolean commandEnabled = false;

        /// <summary>
        /// Random for synth responses
        /// </summary>
        static Random random = new Random();

        /// <summary>
        /// Default responses from synth voice
        /// </summary>
        private List<String> synthResponses = new List<String>();

        /// <summary>
        /// Current rand response for synth voice
        /// </summary>
        private String randomResponse;

        /// <summary>
        /// Speech synthetiser for voice commands
        /// </summary>
        ...
        private void SpeechRecognized(object sender, SpeechRecognizedEventArgs e)
        {
            ...
            if (e.Result.Confidence >= ConfidenceThreshold)
            {
                ...
                {
                    case "DRONE":
                        // Active AR Drone command
                        // Others commands are only available if AR Drone command is enable (say "Drone" to enable command)
                        commandEnabled = true;
                        synth.Speak("yes ?");
        ...
        {
            int randomIndex = random.Next(synthResponses.Count);
            return (string)synthResponses[randomIndex];
        }
    }
}